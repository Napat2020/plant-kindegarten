...
const EditProduct = (props) => {
    ...
    props.firebase.product(props.match.params.productId)
      .once("value", (snapshot) => {
        ...
        if(!snapshot.exists()){
          ...
          setPreviewImage(snapshot.val().previewImage == 'null.jpg' ? null : snapshot.val().previewImage);
  ...
  return(
    ...
    <Button type="submit" className={classes.signInButton}> Update </Button>
    <Button onClick={onDelete}className={classes.deleteButton}> Delete </Button>
